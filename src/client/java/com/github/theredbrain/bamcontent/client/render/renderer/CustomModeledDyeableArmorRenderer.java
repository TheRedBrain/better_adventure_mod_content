...
//
//import com.github.theredbrain.bamcore.client.render.model.CustomModeledDyeableArmorModel;
...
//
//public class CustomModeledDyeableArmorRenderer extends GeoArmorRenderer<CustomModeledDyeableArmorItem> {
//
////    protected GeoBone bodyLeggings = null;
////    protected GeoBone rightHand = null;
////    protected GeoBone leftHand = null;
//
//    public CustomModeledDyeableArmorRenderer(Identifier assetSubpath) {
//        super(new CustomModeledDyeableArmorModel(assetSubpath));
//    }
//    /**
...
//     */
//    @Override
//    public RenderLayer getRenderType(CustomModeledDyeableArmorItem animatable, Identifier texture, @Nullable VertexConsumerProvider bufferSource, float partialTick) {
