...
//
//public class CustomModeledArmorRenderer extends GeoArmorRenderer<CustomModeledArmorItem> {
//
////    protected GeoBone bodyLeggings = null;
////    protected GeoBone rightHand = null;
////    protected GeoBone leftHand = null;
//
//    public CustomModeledArmorRenderer(Identifier assetSubpath) {
//        super(new CustomModeledArmorModel(assetSubpath));
//    }
//    /**
...
//     */
//    @Override
//    public RenderLayer getRenderType(CustomModeledArmorItem animatable, Identifier texture, @org.jetbrains.annotations.Nullable VertexConsumerProvider bufferSource, float partialTick) {
