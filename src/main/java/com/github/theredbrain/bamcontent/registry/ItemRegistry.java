...
public class ItemRegistry {
    ...
    public static final Item LEATHER_GLOVES = registerItem("leather_gloves", new GlovesArmorTrinketItem(1, 0, 0.5, new FabricItemSettings().maxDamage(60)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item LEATHER_SHOULDERS = registerItem("leather_shoulders", new ShouldersArmorTrinketItem(1, 0, 0.5, new FabricItemSettings().maxDamage(60)), ItemGroupRegistry.BAM_EQUIPMENT);
    ...
    public static final Item CHAINMAIL_GLOVES = registerItem("chainmail_gloves", new GlovesArmorTrinketItem(1, 0, 1, new FabricItemSettings().maxDamage(70)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item CHAINMAIL_SHOULDERS = registerItem("chainmail_shoulders", new ShouldersArmorTrinketItem(1, 0, 1, new FabricItemSettings().maxDamage(70)), ItemGroupRegistry.BAM_EQUIPMENT);
    ...
    public static final Item IRON_GLOVES = registerItem("iron_gloves", new GlovesArmorTrinketItem(2, 0, 2, new FabricItemSettings().maxDamage(90)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item IRON_SHOULDERS = registerItem("iron_shoulders", new ShouldersArmorTrinketItem(2, 0, 2, new FabricItemSettings().maxDamage(90)), ItemGroupRegistry.BAM_EQUIPMENT);
    ...
    public static final Item DIAMOND_GLOVES = registerItem("diamond_gloves", new GlovesArmorTrinketItem(3, 0.025, 1.5, new FabricItemSettings().maxDamage(40)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item DIAMOND_SHOULDERS = registerItem("diamond_shoulders", new ShouldersArmorTrinketItem(3, 0.025, 1.5, new FabricItemSettings().maxDamage(40)), ItemGroupRegistry.BAM_EQUIPMENT);
    ...
    public static final Item GOLDEN_GLOVES = registerItem("golden_gloves", new GlovesArmorTrinketItem(1, 0, 2.5, new FabricItemSettings().maxDamage(50)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item GOLDEN_SHOULDERS = registerItem("golden_shoulders", new ShouldersArmorTrinketItem(1, 0, 2.5, new FabricItemSettings().maxDamage(50)), ItemGroupRegistry.BAM_EQUIPMENT);
    ...
    public static final Item NETHERITE_GLOVES = registerItem("netherite_gloves", new GlovesArmorTrinketItem(4, 0.05, 3, new FabricItemSettings().maxDamage(120)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item NETHERITE_SHOULDERS = registerItem("netherite_shoulders", new ShouldersArmorTrinketItem(5, 0.05, 3, new FabricItemSettings().maxDamage(120)), ItemGroupRegistry.BAM_EQUIPMENT);
    //endregion Armor
    ...
    public static final Item MANA_REGENERATION_BELT = registerItem("mana_regeneration_belt", new ManaRegenerationBeltItem(new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT);
    // necklaces
